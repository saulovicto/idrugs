...
app = Flask(__name__, template_folder=BASE_DIR, static_folder=os.path.join(BASE_DIR, 'static'), static_url_path='/static')
CORS(app)
...
@app.route('/colaborador.html')
def serve_colaborador():
